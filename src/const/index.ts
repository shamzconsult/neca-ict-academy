...
export type ApplicationStatus = (typeof statusOptionsMap)[keyof typeof statusOptionsMap];

export type ApplicationLevel = (typeof levelOptionsMap)[keyof typeof levelOptionsMap];
...
export const applicantTableHead = ['Name', 'Email', 'Phone Number', 'State', 'Course', 'Level', 'Status'];
