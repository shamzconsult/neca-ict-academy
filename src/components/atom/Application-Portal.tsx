...
const ApplicationPortal = ({ cohorts, courses }: { cohorts: ApplicationFormProps; courses: CourseType[] }) => {
            ...
            <div className='w-full lg:w-1/2 lg:ml-[50%] bg-white overflow-y-auto h-full pt-5'>
              <div className='max-w-2xl mx-auto px-8 py-8 lg:pr-[10%] text-center lg:text-left'>
                ...
                <p className='text-gray-600 text-xl mb-7'>
                  To apply for our training programs or opportunities, please fill out the form below with accurate information. Ensure all required
                  fields are completed to avoid delays in processing <br /> your application.
                </p>
                  ...
                  <div>
                    ...
                    <div className='relative'>
                      <select
                        ...
                        disabled={isPending}
                        className='w-full p-3 border border-[#1E1E1E] rounded-md focus:outline-none focus:ring focus:ring-[#1E1E1E] appearance-none'>
                        <option value=''>{!courses || courses.length === 0 ? 'No courses available' : 'Select a course'}</option>
                        {courses.length > 0 &&
                          courses.map(course => (
                            <option
                              key={course._id}
          ...
          <div className='flex flex-col justify-center items-center h-screen'>
            ...
            <p>
              ...
              <a
                target='blank'
                href=''
                className='text-red-500 underline px-1'>
                channel
              </a>
