            ...
            <div className='w-full lg:w-1/2 lg:ml-[50%] bg-white overflow-y-auto h-full pt-5'>
              <div className='max-w-2xl mx-auto px-8 py-8 lg:pr-[10%] text-center lg:text-left'>
                ...
                <p className='text-gray-600 lg:text-xl mb-7'>
                  ...
                  fields are completed to avoid delays in processing your application.
                </p>
                ...
                <form
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div>
                      <label className='block text-sm font-medium text-gray-700 text-left mb-2'>Upload CV</label>
                    ...
                    <div>
                      <label className='block text-sm font-medium text-gray-700 text-left mb-2'>Upload Profile Image</label>
                      <div className='relative h-14'>
                        <div className='flex items-center gap-3 p-3 h-full border border-[#1E1E1E] rounded-md focus-within:ring focus-within:ring-[#1E1E1E] cursor-pointer'>
