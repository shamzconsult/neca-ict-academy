...
export const CheckStatusModal: React.FC<CheckStatusModalProps> = ({ email, setEmail, onCheckStatus, emailError, onClose, isPending }) => {
  return (
    <div className='fixed inset-0 bg-black/30 flex justify-center items-center z-50'>
      <div className='bg-white p-6 rounded-lg shadow-lg w-[90%] md:w-[70%] lg:w-[600px] relative'>
        ...
        <h2 className='text-[17px] text-[#27156F] font-bold mb-4'>Check your application status.</h2>
        <label
          htmlFor='email'
        ...
        <input
          ...
          className={`w-full p-3 border ${emailError ? 'border-red-500' : 'border-gray-300'} rounded-md mb-1 mt-2`}
        />
