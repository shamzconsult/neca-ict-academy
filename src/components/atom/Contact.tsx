...
const Contact = () => {
  ...
  return (
  <section className="max-w-6xl font-poppins mt-10">      <div className="max-w-6xl mx-auto py-5 px-4">        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-6">
