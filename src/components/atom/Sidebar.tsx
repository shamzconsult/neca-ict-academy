          ...
          <nav className='mt-10'>
            <Link
              ...
              className={`flex items-center px-3 py-3 text-sm font-medium mx-1 ${
                isActive('/admin/dashboard') ? 'text-[#27156F] border-b-2 w-fit border-[#27156F]' : ' hover:text-[#27156F]'
              }`}>
              <ChartPieIcon
                size={20}
                className='mr-3'
            ...
            <Link
              ...
              onClick={() => setIsOpen(false)}
              className={`flex items-center px-3 py-3 text-sm font-medium mx-1 ${
                isActive('/admin/cohorts') ? 'text-[#27156F] border-b-2 w-fit border-[#27156F]' : ' hover:text-[#27156F]'
              }`}>
              <SquareLibrary
                size={20}
                className='mr-3'
            ...
            <Link
              ...
              onClick={() => setIsOpen(false)}
              className={`flex items-center px-3 py-3 text-sm font-medium mx-1 ${
                isActive('/admin/courses') ? 'text-[#27156F] border-b-2 w-fit border-[#27156F]' : ' hover:text-[#27156F]'
              }`}>
              <BookOpen
                size={20}
                className='mr-3'
            ...
            <Link
              ...
              onClick={() => setIsOpen(false)}
              className={`flex items-center px-3 py-3 text-sm font-medium mx-1 ${
                isActive('/admin/applicants') ? 'text-[#27156F] border-b-2 w-fit border-[#27156F]' : ' hover:text-[#27156F]'
              }`}>
              <UserCog
                size={20}
                className='mr-3'
