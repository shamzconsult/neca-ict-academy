                ...
                <div className="w-full lg:w-full lg:text-left md:p-6 flex flex-col text-center h-full flex-grow">
                    ...
                    <div className="space-y-2 w-full max-w-2xl mt-2">
                        {[
                            ...
                            <div key={index} className={`accordion border-b-3 border-gray-200 pb-4 pt-4 ${index === 0 ? 'border-t-3 border-gray-200' : ''}`}>
                                <button
                                    className="accordion-toggle w-full flex justify-between items-center text-left focus:outline-none cursor-pointer"
                                    onClick={() => toggleAccordion(index)}
                                >
                                    <span className="text-[#1E1E1E] font-semibold text-sm lg:text-[17px]">{faq.question}</span>
                    ...
                    <h2 className="text-[18px] font-bold text-[#27156F] mt-10 lg:mt-5 text-center lg:text-left">Need More information?</h2>
