...
const ApplicationPorter = () => {
  ...
  return (
    <Fragment>
      <section className="relative max-w-6xl mx-auto my-20 mt-[150px] p-6 bg-white rounded-lg overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-evenly items-start gap-8">
            <div className="w-full md:w-1/2 md:pr-8">
              ...
              <h1 className="text-xl font-semibold text-left text-[#1E1E1E] mb-4">Application Timeline</h1>
              <div className="flex justify-around items-center">
                {timelineSteps.map((item, index) => (
                  <Fragment key={item.step}>
                    <div className="text-center items-center">
                      <div className="w-8 h-8 bg-[#525252] rounded-full flex items-center justify-center text-white">
                        {item.step}
                      </div>
                      <p className="mt-2 gap-0">{item.label}</p>
                    </div>
                    {index < timelineSteps.length - 1 && (
                      <div className="flex items-center mb-7">
                        <div className="w-2 h-1 bg-[#525252] mx-1" />
                        <div className="w-3 h-1 bg-[#525252] mx-1" />
                        <div className="w-4 h-1 bg-[#525252] mx-1" />
                        <div className="w-5 h-1 bg-[#525252] mx-1" />
                      </div>
                    )}
                  </Fragment>
                ))}
            ...
            <div className="w-full md:w-1/2">
              ...
              <h2 className="text-xl font-semibold text-[#27156F] mb-4 mt-6">Register Now!</h2>
              <p className="text-gray-600 mb-7">
                To apply for our training programs or opportunities, please fill out the form below with accurate information.
                Ensure all required fields are completed to avoid delays in processing your application.
              </p>
...
export default ApplicationPorter;