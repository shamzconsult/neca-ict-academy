...
export const ApplicantInfoModal = ({ isOpen, onOpenChange, enrollment }: Props) => {
  const { profilePicture, phoneNumber, firstName, lastName, email, state, gender, course, level, status, cv, createdAt } = enrollment;
  return (
    <Dialog
      open={isOpen}
          ...
          <div className='flex flex-col md:flex-row gap-6 items-start'>
            <div className='flex flex-col items-center md:items-start gap-4 w-'>
              ...
              <div className='w-full'>
                ...
                <div className='mb-2'>
                  <strong>Date Applied:</strong> {new Date(createdAt).toLocaleString()}
                </div>
                {cv?.url && (
                  <div className='mb-2'>
                    <strong>CV:</strong>{' '}
